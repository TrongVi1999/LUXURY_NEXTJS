                ...
                <div>
                    ...
                    <Section className={cx('sectionDiff')}>
                        ...
                        <div className={cx('sectionDiffCase')}>
                            ...
                            <BoxImageMice img={Img6} title="DINNING & EVENT VENUES" size={'23%'} />
                            <BoxImageMice img={Img7} title="OUTSTANDING IDEA" size={'23%'} />
                            <BoxImageMice img={Img8} title="LOCAL TRANSPORT EXPERIENCES" size={'23%'} />
                        </div>
                    </Section>
